  ...
  <div class="px-20 py-10">
    ...
    <form class="" action="{{ route('profile.update') }}" method="POST" id="profile-form">
        ...
        <div class="pr-3">
          ...
          <div class="mb-4 mt-5">
            ...
            <input type="email" id="email" name="email"
              ...
              placeholder="johndoe@mail.com" value="{{ auth()->user()->email }}" disabled required />
          </div>
          <div class="mb-4">
            ...
            <input type="text" id="phone" name="phone"
              class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
              placeholder="08123456789" required value="{{ $profile ? $profile->phone : null }}" />
          </div>
        </div>
        <div class="pl-3">
          <div class="mb-4 mt-5">
            ...
            <input type="text" id="address" name="address"
              class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
              placeholder="Jl. Jend. Sudirman No. 1" required value="{{ $profile ? $profile->address : null }}" />
          </div>
          <div class="mb-4 mt-5">
            <label for="job" class="mb-1 block text-sm font-medium text-gray-900 dark:text-white">Pekerjaan</label>
            <input type="text" id="job" name="job"
              class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
              placeholder="Mahasiswa" required value="{{ $profile ? $profile->job : null }}" />
          </div>
          <div class="mb-4">
            ...
            <input type="date" id="birthday" name="birthday"
              class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
              placeholder="12-08-2023" required value="{{ $profile ? $profile->birthday : null }}" />
          </div>
        </div>
      </div>
      <div class="flex items-center justify-center gap-5">
        ...
        <button type="button" onclick="document.getElementById('profile-form').reset()"
      ...
      <form class="" action="{{ route('profile.change-password') }}" method="POST" id="password-form">
        <div class="mb-4 mt-5">
          ...
          <div class="relative flex flex-col justify-center text-stone-500">
            ...
            <i class="fas fa-eye-slash absolute right-5 top-1/2 w-[18px] -translate-y-1/2 transform cursor-pointer text-black"
